...
class Charles:
    ...
    def obstacle_avoidance_searching(self, current_waypoint):
        ...
        if self.move == 3:
            ...
            if (self.is_close_obs(self.range[1]) and (self.xyz[1] >= 0.8)):  # A changer
                # print("I go left")
                velocity_y = -VELOCITY_Y
                velocity_x = 0
            ...
            elif (self.is_close_obs(self.range[1]) and (self.xyz[1] < 0.8)):  # A changer
                # print("I go right")
                velocity_x = 0
                velocity_y = VELOCITY_Y
            ...
            while (self.is_not_close()):
                ...
                if self.state == 0:
                    ...
                    if self.xyz[2] >= self.default_height:
                        ...
                        #self.xyz_rate_cmd = np.array([0., 0.4, 0.])
                        #self.xyz_rate_cmd = np.array([-0.2, 0., 0.])
